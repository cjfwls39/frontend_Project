...
document.addEventListener("DOMContentLoaded", () => {
  ...
  signupForm.addEventListener("submit", async (e) => {
    ...
    try {
      ...
      let sessionUserId = email;
      if (window.UserStorage && typeof window.UserStorage.registerUser === "function") {
        const registered = window.UserStorage.registerUser({
          name,
          email,
        });
        sessionUserId = registered.userId;
      }
